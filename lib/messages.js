...
var errors = {
    ...
    E041: 'the `width` and `height` properties must be set for image tags',
    E042: 'duplicate class: <%= classes %>',
    E043: 'class names are not ordered <%= order %>',
    E044: 'attributes are not ordered <%= order %>',
    E045: 'void element should not close itself',
};
